  ...
  return (
    <div className="row" dir={isArabic ? 'rtl' : 'ltr'} lang={isArabic ? 'ar' : 'fr'}>
      <div className="deliveryCardGroup">
        ...
        <div className="right">
          <p className="deliveryCardTitle">{t('homePage.deliverySection.delivery.title')}</p>
      ...
      <div className="deliveryCardGroup">
        ...
        <div className="right">
          <p className="deliveryCardTitle">{t('homePage.deliverySection.payment.title')}</p>
          <p className="deliveryCardDesc">
      ...
      <div className="deliveryCardGroup">
        ...
        <div className="right">
          <p className="deliveryCardTitle">{t('homePage.deliverySection.service.title')}</p>
          <p  className="deliveryCardDesc">
