              ...
              <Box>
                ...
                <Stack spacing={1}>
                  <Typography variant="body2">
                    <b>Created:</b> {new Date(product?.creationDate).toLocaleDateString()}
                  </Typography>
                  {product?.inSold && (
                    <>
                      <Typography variant="body2">
                        <b>Sale Start:</b> {new Date(product?.startDate).toLocaleDateString()}
                      </Typography>
                      <Typography variant="body2">
                        <b>Sale End:</b> {new Date(product?.lastDate).toLocaleDateString()}
                      </Typography>
                    </>
                  )}
                </Stack>
